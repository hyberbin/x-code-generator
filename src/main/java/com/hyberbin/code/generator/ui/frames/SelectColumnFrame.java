...
public class SelectColumnFrame extends javax.swing.JFrame {
  ...
  private void loadColumns() {
    ...
    List<ColumnMeta> columnMetas = sqliteDao.getColumnMetas(modelMeta.getTableName(), dataSource);
  ...
  private void netxButtonActionPerformed(
    ...
    this.dispose();
    new SelectColumnFrame(datas, index + 1, dataSource).setVisible(true);
    ...
    private void genButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_genButtonActionPerformed
      ...
      for(FieldMeta fieldMeta:datas){
        ...
        if(StringUtils.isBlank(fieldMetaVo.getFieldName())){
          fieldMetaVo.setFieldName(StringUtils.INSTANCE.getCamelCaseString(fieldMetaVo.getColumnName(),false));
        }
      }
